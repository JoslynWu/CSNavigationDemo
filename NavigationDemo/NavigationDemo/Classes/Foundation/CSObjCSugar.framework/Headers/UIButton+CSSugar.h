...
///
/// @return UIButton
+ (nonnull instancetype)cs_buttonWithTitle:(nullable NSString *)title
...
///
/// @return UIButton
+ (nonnull instancetype)cs_buttonWithAttributedText:(nullable NSAttributedString *)attributedText;
...
///
/// @return UIButton
+ (nonnull instancetype)cs_buttonWithImageName:(nullable NSString *)imageName
